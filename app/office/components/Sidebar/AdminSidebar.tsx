...
export default function AdminSidebar() {
  ...
  return (
    <aside
      className={`${
        collapsed ? "w-16" : "w-64"
      } bg-white dark:bg-gray-950 border-l border-gray-200 dark:border-gray-700 h-screen flex flex-col transition-all duration-300 ease-in-out`}
    >
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
        {!collapsed && (
          <Link href="/office" className="flex items-center space-x-2 ml-2">
            <span className="font-bold text-xl text-gray-900 dark:text-white">bOObies.co.il</span>
          </Link>
        )}
        <button
          onClick={() => setCollapsed(!collapsed)}
          className="p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
        >
          {collapsed ? (
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        <button
          ...
          } px-3 py-2.5 text-red-500 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-red-600 dark:hover:text-red-300 rounded-md`}
        >
