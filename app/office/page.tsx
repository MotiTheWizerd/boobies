...
export default function AdminDashboard() {
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">לוח בקרה</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            <Calendar
              mode="single"
              className="rounded-md border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100"
            />
          </CardContent>
        </Card>
          ...
          <CardContent>
            <ul className="space-y-2">
              {[1, 2, 3, 4, 5].map((item) => (
                <li
                  key={item}
                  className="p-3 bg-gray-100 dark:bg-gray-800 rounded-md shadow-sm border border-gray-200 dark:border-gray-700"
                >
